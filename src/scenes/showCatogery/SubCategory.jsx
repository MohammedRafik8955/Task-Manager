...
function SubCategory() {
          ...
          <strong>
            ...
            {userRole !== "ROLE_USER" && (
              <Button
                variant="contained"
                color="error"
                onClick={() => openDeleteDialog(params.row.subCategoryId)}
                startIcon={<Delete />}
              />
            )}
          </strong>
  ...
  const handleAddUser = () => {
    navigate('/subCategory'); // Change '/addUserForm' to the path of your add user form
  };
  ...
  return (
    <Box m="20px">
      ...
      <Box display="flex" justifyContent="flex-end">
        <Button variant="contained" onClick={handleAddUser}>Add SUB CATEGORY</Button>
      </Box>
